...
2. Products → New: three **subscription** products in EUR, monthly: Starter 29, Coach 149, Personal 499. In each product's settings set **Redirect URL** to `https://xgrowth.lol/success.html`.
